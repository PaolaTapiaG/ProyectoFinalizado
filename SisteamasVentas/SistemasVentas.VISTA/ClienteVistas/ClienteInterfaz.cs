...
namespace SistemasVentas.VISTA.ClienteVistas
{
    public partial class ClienteInterfaz : Form
    {
        ...
        private void panel3_Paint(object sender, PaintEventArgs e)
        {
            ...
            path.AddArc(bounds.X, bounds.Y, radio * 2, radio * 2, 180, 90);
            path.AddArc(bounds.X + bounds.Width - (radio * 2), bounds.Y, radio * 2, radio * 2, 270, 90);
            path.AddArc(bounds.X + bounds.Width - (radio * 2), bounds.Y + bounds.Height - (radio * 2), radio * 2, radio * 2, 0, 90);
            path.AddArc(bounds.X, bounds.Y + bounds.Height - (radio * 2), radio * 2, radio * 2, 90, 90);
            path.CloseFigure();
        ...
        private void panel2_Paint(object sender, PaintEventArgs e)
        {
            int radio = 20;
            GraphicsPath path = new GraphicsPath();
            Rectangle bounds = panel2.ClientRectangle;
